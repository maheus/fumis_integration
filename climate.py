...
#from python-fumis import Python-Fumis
...
#SUPPORT_FLAGS = (SUPPORT_TARGET_TEMPERATURE | SUPPORT_TARGET_TEMPERATURE_RANGE | SUPPORT_PRESET_MODE)
...
async def async_setup_platform(hass, config, async_add_entities, discovery_info=None):
    """Old way of setting up the HVAC platform.
...
class FumisClimate(ClimateEntity):
    ...
    # hvac_mode is used for determinate state
    #@property
    #def state(self):
    #    """Return the state."""
    #    return self._state
    ...
    def device_info(self):
        return [self._unit_id, self._unit_version]
